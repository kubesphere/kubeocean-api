...
func (in *KindClusterPoolStatus) DeepCopyInto(out *KindClusterPoolStatus) {
	*out = *in
	if in.SpecificationsStatus != nil {
		in, out := &in.SpecificationsStatus, &out.SpecificationsStatus
		*out = make(map[qingcloud.InstanceType]map[SpecificationPluginType]SpecificationStatus, len(*in))
		for key, val := range *in {
