...
type Interface interface {
	...
	// ClusterClasses returns a ClusterClassInformer.
	ClusterClasses() ClusterClassInformer
...
// ClusterClasses returns a ClusterClassInformer.
func (v *version) ClusterClasses() ClusterClassInformer {
	return &clusterClassInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
