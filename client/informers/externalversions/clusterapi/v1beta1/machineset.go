	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterapiV1beta1().MachineSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterapiV1beta1().MachineSets(namespace).Watch(context.TODO(), options)
			},
		},
		&clusterapiv1beta1.MachineSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterapiv1beta1.MachineSet{}, f.defaultInformer)
}
